...
public class VoteDAOImpl implements VoteDAO {
    ...
    private static final String READ_VOTE =  "SELECT vote_type, discovery_id, user_id, date, type) "
    ...
    public Vote getVoteByUserIdDiscoveryId(long userId, long discoveryId) {
        ...
        SqlParameterSource paramSource = new MapSqlParameterSource(paramMap);
        try {
            vote = template.queryForObject(READ_VOTE_BY_DISCOVERY_USER_IDS, paramSource, new VoteRowMapper());
